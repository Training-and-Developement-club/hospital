...
import hospital.manager.download.chain.JsonMatchChain;
import hospital.manager.download.chain.MatchString;
import hospital.manager.download.chain.XmlMatchChain;
...
import hospital.manager.search.SearchDoctorsByDate;
import hospital.manager.search.SearchPatientByDate;
import hospital.manager.search.SearchPatientByName;
import hospital.manager.sort.*;
...
import static hospital.manager.search.SearchDoctorsByName.search;
